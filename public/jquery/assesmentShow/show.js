$(document).ready(function () {
    $('#upload-form2').submit(function (event) {
        ...
        if (reportType === 'exam') {
            route = examShow_Questions;
        } else if (reportType === 'homework') {
            route = HWShow_Questions;
        }
        $(document).ready(function () {
            $('#upload-form').submit(function (event) {
                ...
                if (reportType === 'exam') {
                    route = "{{ route('admin/examShow/details') }}";
                } else if (reportType === 'homework') {
                    route = "{{ route('admin/HWShow/details') }}";
                }
        ...
        idInput2.type = 'hidden';
        idInput2.name = 'grade';
        idInput2.value = $("select[name='gradeSec2']").val();
        hiddenForm.appendChild(idInput2);
