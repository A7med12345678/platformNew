    ...
    <div class="content-child">
        ...
        <div class="container p-3 pt-5">
            ...
            <div id="accordion">
                    ...
                    <div id="collapseOne" class="collapse" data-bs-parent="#accordion">
                        <div class="card-body">
                            <div class="filtering">
                                ...
                                <form action="{{ route('Admin/showAll') }}" method="GET" class="mt-4">
                                    <div class="form-group">
                                        ...
                                        <select name="sort" id="sort" class="form-control"
                                            ...
                                            <!-- all grades -->
                                            <option value="allWithAdmin"
                                                {{ request('sort') === 'allWithAdmin' ? ' selected' : '' }}>All
                                                With
                                                Admins</option>
                                            <optgroup label="Grades">
                                                <option value="all"
                                                    {{ !request('sort') || request('sort') === 'all' ? ' selected' : '' }}>
                                                    Default</option>
                                        ...
                                        <option value="offline" {{ request('sort') === 'offline' ? ' selected' : '' }}>Offline</option>
                                            ...
                                            <optgroup label="Pay - Grades">
                                                ...
                                                <option value="pay2" {{ request('sort') === 'pay2' ? ' selected' : '' }}>
                                                    Pay - 2 Sec
                                                </option>
                                                <option value="pay3" {{ request('sort') === 'pay3' ? ' selected' : '' }}>
                                                    Pay - 3 Sec
                                                </option>
                                            </optgroup>
                                            <!-- block - all grades -->
                                            <optgroup label="Blocked - Grades">
                                                ...
                                                <!--</option>-->
                                                <option value="block2"
                                                    {{ request('sort') === 'block2' ? ' selected' : '' }}>Blocked -
                                                    2
                                                    Sec
                                                </option>
                                                <option value="block3"
                                                    {{ request('sort') === 'block3' ? ' selected' : '' }}>Blocked -
                                                    3
                                                    Sec
                                                </option>
                                            </optgroup>
                                            ...
                                            <optgroup label="No Pay - Grades">
                                                ...
                                                <!--</option>-->
                                                <option value="nopay2"
                                                    {{ request('sort') === 'nopay2' ? ' selected' : '' }}>No pay - 2
                                                    Sec
                                                </option>
                                                <option value="nopay3"
                                                    {{ request('sort') === 'nopay3' ? ' selected' : '' }}>No pay - 3
                                                    Sec
                                                </option>
                                            </optgroup>
                                            <!-- pay - no pay -->
                                            <optgroup label="Pay - All Grades">
                                                <option value="pay" {{ request('sort') === 'pay' ? ' selected' : '' }}>
                                                    Pay</option>
                                                <option value="nopay"
                                                    {{ request('sort') === 'nopay' ? ' selected' : '' }}>Not Paid
                                                </option>
                                            </optgroup>
                                            <!-- type -->
                                            <optgroup label="Type - All Grades">
                                                <option value="typegradeGENERAL"
                                                    {{ request('sort') === 'pay' ? ' selected' : '' }}>
                                                    General
                                                </option>
                                                <option value="typegradeAZHAR"
                                                    {{ request('sort') === 'typegradeAZHAR' ? ' selected' : '' }}>
                                                    Azhar</option>
                                            </optgroup>
                                            {{-- type - grades  --}}
                                            <optgroup label="Type - Grades">
                                                <option value="typegradeGENERAL1"
                                                    {{ request('sort') === 'typegradeGENERAL1' ? ' selected' : '' }}>
                                                    General 1</option>
                                                <option value="typegradeGENERAL2"
                                                    {{ request('sort') === 'typegradeGENERAL2' ? ' selected' : '' }}>
                                                    General 2</option>
                                                <option value="typegradeGENERAL3"
                                                    {{ request('sort') === 'typegradeGENERAL3' ? ' selected' : '' }}>
                                                    General 3</option>
                                                <option value="typegradeAZHAR1"
                                                    {{ request('sort') === 'typegradeAZHAR1' ? ' selected' : '' }}>
                                                    Azhar 1</option>
                                                <option value="typegradeAZHAR2"
                                                    {{ request('sort') === 'typegradeAZHAR2' ? ' selected' : '' }}>
                                                    Azhar 2</option>
                                                <option value="typegradeAZHAR3"
                                                    {{ request('sort') === 'typegradeAZHAR3' ? ' selected' : '' }}>
                                                    Azhar 3</option>
                                            </optgroup>
                                            {{-- type - pay - all grades  --}}
                                            <optgroup label="Type, Pay - All Grades">
                                                ...
                                                <option value="typegradeAZHARpay"
                                                    {{ request('sort') === 'typegradeAZHARpay' ? ' selected' : '' }}>Azhar
                                                    Pay</option>
                                            </optgroup>
                                            ...
                                            <optgroup label="Type, Pay - Grades">
                                                <option value="typegradeAZHAR1pay"
                                                    {{ request('sort') === 'typegradeAZHAR1pay' ? ' selected' : '' }}>Azhar
                                                    1 Pay
                                                </option>
                                                <option value="typegradeAZHAR2pay"
                                                    {{ request('sort') === 'typegradeAZHAR2pay' ? ' selected' : '' }}>Azhar
                                                    2 Pay
                                                </option>
                                                <option value="typegradeAZHAR3pay"
                                                    {{ request('sort') === 'typegradeAZHAR3pay' ? ' selected' : '' }}>Azhar
                                                    3 Pay
                                                </option>
                                            </optgroup>
                                            {{-- type - no pay - grades  --}}
                                            ...
                                            <optgroup label="Deleted - Grades">
                                                <option value="allDeleted"
                                                    {{ request('sort') === 'allDeleted' ? ' selected' : '' }}>
                                                    All
                                                    Deleted</option>
                                                <option value="deleted1"
                                                    {{ request('sort') === 'deleted1' ? ' selected' : '' }}>
                                                    Deleted 1
                                                </option>
                                                <option value="deleted2"
                                                    {{ request('sort') === 'deleted2' ? ' selected' : '' }}>
                                                    Deleted 2
                                                </option>
                                                <option value="typegradeAZHAR2pay"
                                                    {{ request('sort') === 'deleted3' ? ' selected' : '' }}>
                                                    Deleted 3</option>
                                            </optgroup>
                                            <optgroup label="Profile">
                                                <option value="profile"
                                                    {{ request('sort') === 'profile' ? ' selected' : '' }}>All
                                                    Has Profile</option>
                                            </optgroup>
                                        </select>
                                    </div>
                                ...
                                <form action="{{ route('Admin/showAll') }}" method="get" class="form-inline">
                                    <label for="searchAll" class="mb-2">Search All :</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="search" id="searchAll" class="form-control"
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        <input id="search" type="text" class="form-control"
                                            placeholder="ahmed , 567 , 01111111111 ..">
                ...
                <div class="mb-3">
                    Current Filter Number : <span class="text-danger h5"
                        style="font-weight:bold;">{{ $currentCount }}</span>
                </div>
            ...
            <div class="text-center m-4">
                {{ $current->appends(['sort' => $sort, 'search' => request('search')])->links() }}
            </div>
        </div>
    </div>
@endsection
