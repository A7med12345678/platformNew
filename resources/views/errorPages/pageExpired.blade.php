...
<body>
    ...
    <div align="center">
        <a class="btn-back" href="{{ route('welcome') }}">Back to previous page</a>
    </div>
    <img src="https://assets.codepen.io/1538474/astronaut.svg" class="astronaut" />
    <img src="https://assets.codepen.io/1538474/spaceship.svg" class="spaceship" />a
</body>
</html>
