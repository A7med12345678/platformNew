...
@section('content')
    ...
    <div class="p-5">
        ...
        alt="" width="200" height="200"> --}}
                ...
                <div class="avatar-upload">
                    <div class="avatar-edit" style="border-color: black;">
                        <form action="{{ route('updateProfile', $user->center_code) }}" method="post"
                            enctype="multipart/form-data" id="profile-form">
                            @csrf
                            @method('POST')
                            <input type="file" id="profile_photo" name="profile_photo" accept=".png, .jpg, .jpeg"
                    ...
                    <div class="avatar-preview">
                        <div id="imagePreview"
                            style="background-image: url({{ asset('storage/profiles/' . $user->profile_photo) }});">
                        </div>
                    </div>
                </div>
        ...
        <form action="{{ route('admin/updateStudent', $user->center_code) }}" method="post">
            ...
            <button type="submit" class="btn btn-success class-guest mt-3">Update</button>
        </form>
